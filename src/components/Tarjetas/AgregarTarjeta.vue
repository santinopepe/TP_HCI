      ...
      <form @submit.prevent="addCard">
        <div class="grid grid-cols-1 gap-4 mb-6">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label for="cardExpiry" class="block text-sm font-medium text-gray-700 mb-1">Fecha de Vencimiento (MM/AA)</label>
              <input
                type="text"
                id="cardExpiry"
            ...
            <div>
              <label for="cardCvv" class="block text-sm font-medium text-gray-700 mb-1">CVV/CVC</label>
              <input
                type="text"
                inputmode="numeric"
                id="cardCvv"
...
const validateForm = () => {
  ...
  if (!/^\d{2}\/\d{2}$/.test(newCard.value.expiry)) {
    errors.value.expiry = 'La fecha de vencimiento debe tener el formato MM/AA.';
    isValid = false;
  } else {
    errors.value.expiry = '';
  }
