<template>
  ...
  >
    <div
      class="bg-white p-6 rounded-lg shadow-md w-full max-w-md relative min-h-[300px] flex flex-col"
    >
      <div
      ...
      <div class="pt-10 flex-grow">
        ...
        <form
          @submit.prevent="$emit('verify-code')"
...
export default {
  ...
  emits: ["update:code", "verify-code", "cancel"],
};
</script>
