        ...
        <table class="w-full text-left min-w-[900px]">
          ...
          <tbody>
            ...
            >
              ...
              <td
                class="p-3 text-center flex items-center justify-center space-x-2"
              >
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      activeButton,
      searchQuery,
      sortedLinks: computed(() => cobrosStore.sortedLinks),
      totalCollected: computed(() => cobrosStore.totalCollected),
      activeLinks: computed(() => cobrosStore.activeLinks),
      totalLinks: computed(() => cobrosStore.totalLinks),
