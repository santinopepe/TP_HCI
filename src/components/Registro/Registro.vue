    ...
    <div class="bg-white p-10 rounded-3xl shadow-2xl w-full max-w-3xl flex flex-col items-center">
      ...
      <form v-if="!showSuccessModal" @submit.prevent="register" class="w-full">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label for="lastName" class="block mb-1 text-gray-800 font-medium">Apellido</label>
            <input
              type="text"
              id="lastName"
              v-model="lastName"
          ...
          <div>
            <label for="birthDate" class="block mb-1 text-gray-800 font-medium">Fecha de Nacimiento</label>
            <input
              type="date"
              id="birthDate"
              v-model="birthDate"
          ...
          <div>
            <label for="email" class="block mb-1 text-gray-800 font-medium">Correo Electrónico</label>
            <input
              type="email"
              id="email"
              v-model="email"
        ...
        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label for="password" class="block mb-1 text-gray-800 font-medium">Contraseña</label>
            <div class="relative">
              <input
              ...
              >
                <svg v-if="showPassword" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <svg v-else xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3l18 18M1.5 12s4-7.5 10.5-7.5c2.5 0 4.7.7 6.5 1.8M22.5 12s-4 7.5-10.5 7.5c-2.5 0-4.7-.7-6.5-1.8M9.5 9.5a3.5 3.5 0 0 1 5 5"/>
                </svg>
              </button>
            </div>
          ...
          <div>
            <label for="confirmPassword" class="block mb-1 text-gray-800 font-medium">Confirmar Contraseña</label>
            <div class="relative">
              <input
              ...
              >
                <svg v-if="showConfirmPassword" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1.5 12s4-7.5 10.5-7.5S22.5 12 22.5 12s-4 7.5-10.5 7.5S1.5 12 1.5 12z" />
                  <circle cx="12" cy="12" r="3.5" stroke="currentColor" stroke-width="2" fill="none"/>
                </svg>
                <svg v-else xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label for="phone" class="block mb-1 text-gray-800 font-medium">Teléfono</label>
            <input
              type="tel"
              id="phone"
              v-model="phone"
...
export default {
  ...
  methods: {
    async register() {
      ...
      // Validación de teléfono: debe empezar con 11 y tener 10 dígitos en total
      if (!this.phone) {
        this.errors.phone = 'El teléfono es obligatorio.';
        valid = false;
      } else if (!/^11\d{8}$/.test(this.phone)) {
        this.errors.phone = 'El teléfono debe comenzar con 11 y tener 10 dígitos en total.';
        valid = false;
      } else {
        this.errors.phone = '';
      }
